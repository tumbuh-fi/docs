...
|---|---|---|
| **TumbuhRouter** | The user-facing entry layer; per-user position accounting; receipt-token mint and burn; deposit-asset ↔ vault-asset swaps for deposits and withdrawals | Vault-asset accounting; strategy allocation; fee collection |
