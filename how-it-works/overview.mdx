...
<Info>
The web app at [app.tumbuh.fi](https://app.tumbuh.fi) displays your receipt-token balance — the amount you originally deposited. The yield-bearing portion of your position (held as vault shares by the protocol on your behalf) is not currently displayed; you realise the yield at withdrawal, when your receipt burns for more deposit asset than you originally deposited.
</Info>
