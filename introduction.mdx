...
The name *tumbuh* means "to grow" in Bahasa Indonesia. The protocol's currently supported assets are listed on the [Tokens](/tokens) page; additional deposit assets can be added over time without changes to the underlying vault.
